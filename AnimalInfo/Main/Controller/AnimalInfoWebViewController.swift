...
enum AnimalInfoWebProtocol {
    case http
    case other
    case key
}

class AnimalInfoWebViewController: AnimalInfoBaseViewController {
    ...
    public var type: AnimalInfoWebProtocol = .http
...
extension AnimalInfoWebViewController: WKNavigationDelegate, WKScriptMessageHandler {
