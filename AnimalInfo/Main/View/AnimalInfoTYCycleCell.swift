...
class AnimalInfoTYCycleCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        self.image.image = UIImage(named: "bg1")
    ...
    func addImage(url: String) {
        image.loadImage(url: url, placeholder: UIImage(named: "bg1"), options: [.transition(.fade(0.5)), .keepCurrentImageWhileLoading], completionHandler: nil)
    }
}
